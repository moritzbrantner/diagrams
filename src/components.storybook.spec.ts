...
const storyIds = [
  ...
  "diagrams-components--interactive-canvas-relationship-map-story",
  ...
  "diagrams-uml-diagram--interactive-canvas-uml-diagram",
  ...
  "diagrams-components--interactive-canvas-dependency-graph-story",
